...
(function(){
  ...
  EventBroker = (function(superclass){
    var separator, acceptor, prototype = extend$((import$(EventBroker, superclass).displayName = 'EventBroker', EventBroker), superclass).prototype, constructor = EventBroker;
    separator = ":";
    acceptor = "*";
